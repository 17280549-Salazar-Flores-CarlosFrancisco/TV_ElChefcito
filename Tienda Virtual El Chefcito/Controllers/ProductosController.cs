...
namespace Tienda_Virtual_El_Chefcito.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_producto,nombre,marca,descripcion,existencia,precio_venta,stock,id_subcategoria,estatus,imagen")] Productos productos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_producto,nombre,marca,descripcion,existencia,precio_venta,stock,id_subcategoria,estatus,imagen")] Productos productos)
        {
            if (ModelState.IsValid)
            {
